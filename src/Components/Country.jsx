...
const Country = ({ country, handleVisitedCountries }) => {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl font-bold">Name: {name.common}</h3>
      <p className="text-xl font-normal">Official: {name.official}</p>
      <div>
        <p className="text-xl font-normal">Population: {population}</p>
        <p>Area: {area}</p>
        <p>Code: {cca3}</p>
        <div>
          <button
